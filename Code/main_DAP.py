...
with tf.Session() as sess:
    ...
    for i in range(epochs):
        ...
        print("epoch", i+1, ":")
        img_tensor_train, img_attribute_train, _, img_label_train = Get_next_batch("train", batch_size)

        img_tensor_vali, img_attribute_vali, _, img_label_vali = Get_next_batch("validation", batch_size)
...
def Get_next_batch(Train_or_Vali, batch_size):
    ...
    return img_batch, attribute_batch, label_batch